...
interface ReadByRecipientsAttrs {
  readByUserId: string;
}

interface ReadByRecipientsDoc extends mongoose.Document {
  readByUserId: string;
}
...
interface ChatMessageAttrs {
  ...
  message: string;
  postedByUser: string;
  readByRecipients: [ReadByRecipientsAttrs];
}

interface ChatMessageModel extends mongoose.Model<any> {
  build(attrs: ChatMessageAttrs): any;
  createPostInChatRoom(
    chatRoomId: string,
    message: {},
    postedByUser: string
  ): any;
  getConversationByRoomId(chatRoomId: string, options: {}): any;
  markMessageRead(chatRoomId: string, currentUserOnlineId: string): any;
